...
export const projects = pgTable('projects', {
  ...
  taskTableId: varchar('task_table_id', { length: 100 }),
  pipelineTableId: varchar('pipeline_table_id', { length: 100 }),
  capacityTableId: varchar('capacity_table_id', { length: 100 }),
  riskTableId: varchar('risk_table_id', { length: 100 }),
  changeTableId: varchar('change_table_id', { length: 100 }),
